...
*!  Stata version 9.0; genyhats version 2, updated Apr'23 by Mark from major re-write in June'22; tweaks in July'22
	...
	local optMask = "STUbprefix(name) LIMitdiag(integer -1) INCludemissing NOSTUbprefix"					    	 				//	**
