...
*!  Stata version 9.0; genyhats version 2, updated Feb-May'23 by MNF from major re-write in June'22
	...
	local optMask = "ADDvars(varlist) CONtextvars(varlist) STAckid(varname) MINofrange(string) MAXofrange(string) "IPRefix(name) ///**
...
*	*************************
	stackmeWrapper geniimpute `0' \ prfxtyp(`prfxtyp') `optMask' // Name of stackme cmd followed by rest of cmd-line				
